    ...
    >
      ...
      >
        ...
        <div style={{ margin: "auto 0" }}>
          ...
          <p
            style={{
              fontSize: "clamp(0.9rem, 1.5vh, 1rem)",
              color: "#444",
              lineHeight: 1.4,
          ...
          {/* TOC Items */}
          <div
            style={{ display: "flex", flexDirection: "column", gap: "clamp(0.35rem, 0.8vh, 0.4rem)" }}
          >
            {TOC_ITEMS.map((item, i) => (
              <div
                ...
                style={{
                  ...
                  padding: "clamp(0.6rem, 1.2vh, 0.75rem) clamp(1rem, 1.5vw, 1.25rem)",
                  borderRadius: "12px",
                  background: "#f8f9fb",
              ...
              >
                <span
                  style={{
                    fontSize: "clamp(1.25rem, 2vh, 1.4rem)",
                    fontWeight: 800,
                    color: "#ff6a00",
                    minWidth: "2.2rem",
                ...
                <div style={{ flex: 1 }}>
                  <div
                    style={{
                      fontSize: "clamp(0.95rem, 1.5vh, 1.05rem)",
                      fontWeight: 700,
                      color: "#012787",
                      marginBottom: "0.1rem",
                    }}
                  ...
                  <div
                    style={{
                      fontSize: "clamp(0.8rem, 1.2vh, 0.9rem)",
                      color: "#666",
                      lineHeight: 1.2,
                    }}
                  >
